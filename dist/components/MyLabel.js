...
var MyLabel = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)("span", __assign({ className: ["label", size, "text-" + color].join(" "), style: {
                color: fontColor,
            } }, { children: allCaps ? label.toUpperCase() : label }), void 0) }, void 0));
};
